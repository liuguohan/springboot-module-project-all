...
public class Constants {
    ...
    public static final String  CONFIG_PROPERTIES_KEY = "config.properties.properties.file";
	...
	//删除状态[0未删除;1删除;]
	public static final int DEL_STATUS_NO = 0;//0未删除
	public static final int DEL_STATUS_YES = 1;//1删除
