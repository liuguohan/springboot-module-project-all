...
public class UserConstant {
	 ...
	 * 学车报名状态
	 */
	public static final int LEARN_APPLY_STATUS_NO = 0; //未报名
	public static final int LEARN_APPLY_STATUS_WAIT = 1; //已报名(未交费)
	public static final int LEARN_APPLY_STATUS_SUCCESS = 2; //已报名(已缴费)

	//学车贷申请审核状态
	public static final int LOAN_STATUS_CHECKING=0;//审核中
	public static final int LOAN_STATUS_PASS=1;//审核通过
	public static final int LOAN_STATUS_UNPASS=2;//审核不通过

	//学车贷支付状态
	public static final int PAY_STATUS_WAIT=0;//未支付
