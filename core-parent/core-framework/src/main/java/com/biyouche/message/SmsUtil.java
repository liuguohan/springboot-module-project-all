...
public class SmsUtil {
	...
	public static boolean send(String mobile,String type,String code) {
		...
		//*********************************************************************************************************************
		result = restAPI.sendTemplateSMS(mobile,type,new String[]{code,SmsConstant.TIME});
