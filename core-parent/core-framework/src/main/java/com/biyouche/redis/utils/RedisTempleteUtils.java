...
//    private static String redisKeyPrefix = PropertiesUtil.getValueByKey(CacheUtils.class.getResource("/").getPath() + "config.properties/redis.properties", "redis.keyPrefix");
    private static String redisKeyPrefix = RedisKeyPrefix.DEMOPREFIX;
